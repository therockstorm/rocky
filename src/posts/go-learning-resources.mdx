...
Identify separate pieces of work and compose their interactions with channels. Separating processes makes programs simple to follow and leads to better design. More info, [Pipelines](https://go.dev/blog/pipelines), [Concurrency Is Not Parallelism](https://www.youtube.com/watch?v=cN_DpYBzKso)

## Up your game

- The [Go Blog](https://go.dev/blog/index) has great articles in general, a few in particular follow
