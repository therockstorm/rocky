...
<Figure caption="Del Rio to Big Bend. 315 miles." id="day-9" />
...
<Figure caption="Swarming with US Border Patrol" id="border-patrol" />
...
<Figure caption={`It says "Please Don't Open" around the cap. I don't want to know why.`} id="bathroom-key" />
...
<Figure caption="The Wild West" id="big-bend" />
...
<Figure caption="Study Butte" id="big-bend-2" />
...
<Figure caption="Santa Elena Canyon" id="santa-elena" />
...
<Figure caption="Pale Hands Warren" id="pale-hands" />
...
<Figure caption="Big Bend" id="big-bend-curving-road" />
...
<Figure caption="Melted in the desert heat" id="melted" />
