...
<Figure caption="Gulf Shores to New Orleans. 198 miles." id="day-4" />
...
<Figure caption={`If you look closely, the sign used to say, "No Food, No Kids, No Nothing". This lady is pleased "No Kids" was removed.`} id="gator-food" />
...
<Figure
  caption="New Orleans sunset from Crecent Park"
  id="sunset-new-orleans"
/>
...
<Figure caption="Beignets at Café du Monde" id="beignets" />
...
<Figure caption="Brad. Rocky." id="brad-and-i" />
...
<Figure caption="Vaughan's Lounge" id="vaughans-lounge" />
