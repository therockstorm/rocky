...
<Figure caption={`The minibar at El Cosmico is in a tackle box and includes rolling papers, a "Marfa Shag" dime bag, and a "Get busy bag" with condoms and Astroglide.`} id="mini-bar" />
