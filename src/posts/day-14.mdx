...
<Figure
  caption="A floating tree at the source of a waterfall on top of the world's largest natrual arch bridge. I couldn't get the rainbow 20 feet down in the picture. What a sight."
  id="floating-tree"
/>
