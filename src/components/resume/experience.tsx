        ...
        positions: [
          {
            ...
            location: "Remote",
            desc: [
              `Automate user management (IAM) and resource provisioning across multiple AWS accounts using AWS Organizations and AWS's Infrastructure as Code (IaC) tool, CDK.`,
              ...
              `Author ERC-20 compatible Solidity smart contracts, coordinate external code audits, and built automated multi-blockchain deployment infrastructure.`,
              `Set up ingestion of application, CloudTrail, GuardDuty, VPC flow, and load balancer access logs into Datadog. Use Cloud SIEM to alert on anomalous activity and mitigated 100% of PCI, SOC 2, and GDPR rule findings.`,
              ...
              `Proposed and implemented multi-signature hardware wallet signing process for smart contract and cryptocurrency custodial wallet access control taking care to prevent locked assets.`,
              ...
              `Coordinated company-wide phishing training and engineering team OWASP Top 10 awareness.`,
