        ...
        positions: [
          {
            ...
            desc: [
              ...
              `Set up ingestion of application, CloudTrail, GuardDuty, VPC flow, and load balancer access logs into Datadog. Mitigate PCI, SOC 2, and GDPR rule findings and use Cloud SIEM to alert on both new findings and anomalous activity.`,
