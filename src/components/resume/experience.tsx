        ...
        positions: [
          {
            ...
            desc: [
              ...
              `Deploy Fleetsmith and Kandji to company endpoints to gather telemetry, manage software patches, and enforce security rules such as disk encryption and malware protection.`,
