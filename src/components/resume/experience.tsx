        ...
        positions: [
          {
            ...
            desc: [
              ...
              `Encourage and, if possible, enforce best practices such as only temporary credentials for AWS access, password managers for employee secrets, AWS Secrets Manager for software secrets, and hardware security keys when using Git over SSH.`,
