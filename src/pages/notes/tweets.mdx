...
- First post on my new blog, Serverless Webhooks #serverless #webhooks #lambda @jeremy_daly @dwolla https://www.rocky.dev/lessons-learned-from-sending-millions-of-serverless-webhooks
...
- Basically Postman for gRPC, helpful for making one-off calls to your services https://github.com/bloomrpc/bloomrpc
...
- Enjoying Dependabot for keeping Node dependencies up-to-date on Github. It's available for other languages as well. Recommend configuring it to monthly updates... https://github.com/dependabot/dependabot-core
- New blog post, Kotlin: First Impressions #kotlin https://www.rocky.dev/kotlin-first-impressions
...
- The content from a talk I gave a couple weeks ago in blog form. Scala: The Good Parts #scala https://www.rocky.dev/scala-the-good-parts
- New blog post: When IntelliJ Loses Its Mind, Run This https://www.rocky.dev/when-intellij-loses-its-mind-run-this
- Hi, Twitter. Forgot about you. Here's some #serverless stuff. https://www.serverless.com/blog/reinvent-2019-serverless-announcements/
...
- End your day with a script instead of working until your dog assumes you've passed away. https://www.rocky.dev/use-a-script-to-call-it-a-day
...
- @samokhvalov I added an update to the bottom incorporating your improvements, thanks! https://www.rocky.dev/full-text-search#2020-09-08-update
...
- New blog post, "Full-Text Search Battle: PostgreSQL vs Elasticsearch" https://www.rocky.dev/full-text-search
...
- Check out my new blog post on Scala Best Practices https://www.rocky.dev/scala-best-practices
- The endless tweaking of my new website has to end at some point...I'm selling some of my photography at https://www.rockywarren.com!
...
- I recently earned the AWS Solutions Architect - Associate certification, here are my study notes. #aws #certifications #solutionsarchitect https://www.rocky.dev/notes
...
- Learning Scala? Here are some resources I've found helpful. #scala https://www.rocky.dev/scala-learning-resources
...
- Couple of useful Docker cleanup commands, one to delete all containers using a particular image and the other to delete all images from a particular repository https://www.rocky.dev/notes/docker
...
- New blog post, "Git Fundamentals" https://www.rocky.dev/git-fundamentals
...
- New blog post, "Start Local Services Fast in Zero Lines of Code with Docker Compose", https://www.rocky.dev/start-local-services-fast-in-zero-lines-of-code-with-docker-compose
...
- New blog post, "Running Linux GUI Apps in Docker on Mac", https://www.rocky.dev/running-linux-gui-apps-in-docker-on-mac
...
- New blog post, "Rust: First Impressions", https://www.rocky.dev/rust-first-impressions
...
- New blog post, "OpenAPI Spec-First API Development", https://www.rocky.dev/openapi-spec-first-api-development
...
- New blog post, "Death to (Synchronous) Standups", https://www.rocky.dev/death-to-standups
...
- New blog post, "Hashing vs Encryption", https://www.rocky.dev/hashing-vs-encryption
