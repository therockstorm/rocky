...
export default function Home({ articles }: Props) {
  ...
  const description = `I'm a software and security engineer based in Denver. I love learning and teaching. This site is my collection of learnings. Away from my keyboard, I've ridden across the United States on a motorcycle, across Canada on a train, and across Iowa on a bicycle.`;
  const title = `${AUTHOR}: Principal engineer, aspiring Father of the Year.`;
