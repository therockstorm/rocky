...
import clearLake from "./clear-lake.jpg";
import day1 from "./day-1.jpg";
import daytonaSpeedway from "./daytona-speedway.jpg";
import harleyCedarKey from "./harley-cedar-key.jpg";
import ksc from "./ksc.jpg";
import ocala from "./ocala.jpg";
...
export const meta = {
  ...
  description:
    "My one-way flight from San Francisco to Orlando arrived just before 5 p.m. on Saturday evening. The airport, I find, blocks Uber and Lyft so I wait in the ca...",
};
...
<Figure caption="Orlando to Cedar Key. 245 miles." src={day1} />
...
<Figure caption="Kennedy Space Station, Cape Canaveral" src={ksc} />
...
<Figure caption="Daytona International Speedway" src={daytonaSpeedway} />
...
<Figure caption="Me and my Harley in Cedar Key" src={harleyCedarKey} />
