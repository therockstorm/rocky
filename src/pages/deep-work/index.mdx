...
export const meta = {
  ...
  description:
    "Implementing a deep work culture and fostering it as companies grow gives startups a strong competitive advantage over larger companies: increased per-employee productivity.",
};
