...
export const meta = {
  ...
  title: "Reading List",
  description:
    "A collection of articles I recommend, along with their summaries.",
};

export default (props) => <ArticleLayout meta={meta} {...props} />;

I read a lot. The following are some of my favorite articles along with a ChatGPT-produced summary.
...
- [The Importance of Cultivating a Deep Work Culture](../deep-work)
...
[Paywall bypass URL](https://archive.is/KeLul)
