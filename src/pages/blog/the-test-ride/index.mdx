...
import chieftainTestRide from "./chieftain-test-ride.jpg";
import kidsSleepingBag from "./kids-sleeping-bag.jpg";
import oceanCove from "./ocean-cove.jpg";

export const meta = {
  date: "2017-05-06",
  title: "The Test Ride Was a Near Disaster. And a Great Success.",
  description:
    "Last weekend I rented the bike I had reserved for my trip because I'd never ridden it before and wanted to make sure I could handle it. I'm pleased that I di...",
};
...
<Figure caption="My brand new sleeping bag." src={kidsSleepingBag} />
