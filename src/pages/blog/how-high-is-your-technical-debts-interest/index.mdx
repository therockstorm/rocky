...
export const meta = {
  ...
  description: "Moving fast is a crucial competitive advantage. However, this speed is sometimes translated to "ship as fast as possible and only fix the mess you create...",
};
