...
import day2 from "./day-2.jpg";
import notInCa from "./not-in-ca.jpg";
import panamaCityBeachBoardwalk from "./panama-city-beach-boardwalk.jpg";
import panamaCityBeachSunset from "./panama-city-beach-sunset.jpg";
import rockys from "./rockys.jpg";
import worldSmallestPoliceStation from "./worlds-smallest-police-station.jpg";

export const meta = {
  date: "2017-05-08",
  title: "Cedar Key to Panama City Beach's Seediest of Motels",
  description:
    "After quite a delay and a couple death threats from friends, I have some time sitting by Lady Bird Lake in Austin, TX to write about the past few days. My in...",
};
...
<Figure caption="Cedar Key to Panama City Beach. 268 miles." src={day2} />
...
<Figure caption="We're not in California anymore" src={notInCa} />
...
<Figure
  caption="My name brother in west Florida has his priorities in order"
  src={rockys}
/>
...
<Figure
  ...
  src={worldSmallestPoliceStation}
/>
...
<Figure caption="Sunset over Panama City Beach" src={panamaCityBeachSunset} />
