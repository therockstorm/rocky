...
- The main Go influence seems to be coroutines (lightweight threads) for async code. They also reminded me of C#'s `async`/`await`, [here's a good explanation](https://kotlinlang.org/docs/coroutines-basics.html).
