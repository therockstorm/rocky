  ...
  <div class="content-background" style="max-width:700px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/day-17.png" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          Kingman to Los Angeles. 375 miles, markers 52-56 on the{" "}
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/oatman-jail.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          Jail in the Oatman, AZ ghost town. I could live here.
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:550px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/roys-motel.jpeg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          Historic Roy's Motel along Route 66 in Amboy, CA.
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:500px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/joshua-tree.jpeg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/jumbo-rocks.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          An artist's rendering of what camping at Jumbo Rocks may have looked
          like
        </figcaption>
      </div>
    </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/helmet-sideways.jpg" alt="" />
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:450px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/space-x.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          The first orbital rocket to launch into space and then land safely
          back on Earth. SpaceX headquarters, Hawthorne, CA
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/hyperloop.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">The Hyperloop test track</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/bike-on-trailer.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">I hate goodbyes</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      <div class="content-container">
        <img src="../../assets/santa-monica-beach.jpg" alt="" />
      </div>
      <div class="caption-container">
        <figcaption class="caption">
          80 miles in, I stared at the Atlantic wondering what on Earth I'd
          done. Over 4,000 miles later, I'm overwhelmed by the Pacific and with
          what on Earth I've done.
        </figcaption>
      </div>
    </div>
  </div>
