...
<figure class="centered">
  <div class="content-background" style="max-width:700px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Flagstaff to Kingman. 372 miles, markers 45-52 on the{" "}
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Big Wheel Harley Road Glide. Source: hotbikeweb.com
        </figcaption>
      </div>
    </div>
  </div>
...
We flip through a few more before he puts his phone away and wishes me safe travels. <a target="_blank" href="http://www.atlasobscura.com/">Atlas Obscura</a> is a site that lists off the beaten path attractions and I've been using it throughout the trip. The plan today is to go 60 miles out of my way to see Bedrock City north of Flagstaff because it looks so stupid I have to go. Then, I'll turn around and pick up Route 66 on my way to Kingman, AZ. The ride up Hwy 64 is uneventful and at 9:30 a.m. I pull into the parking lot.
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Bedrock City from The Flintstones
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Late night booty calls on the bone phone
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          You best belive I rode down the tail slide
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:550px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Wild Elk stealing human water at the Visitor's Center
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">The Grand Canyon, South Rim</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">A fellow lone wolf</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">Bears. At Bearizona.</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">Roadkill Cafe in Seligman, AZ</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">Route 66</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background" style="max-width:600px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          My glamorous accomodations for the next two nights
        </figcaption>
      </div>
    </div>
  </div>
...
<figure class="centered">
  <div class="content-background" style="max-width:550px;">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">Mr. D'z Diner</figcaption>
      </div>
    </div>
  </div>
</figure>
...
<figure class="centered">
  <div class="content-background">
    <div class="content-border">
      ...
      <div class="caption-container">
        <figcaption class="caption">
          Massive steam-powered locomotive in Kingman, AZ
        </figcaption>
      </div>
    </div>
  </div>
