...
Next, I created a strategy card in Excel and used Paint.NET to save it as a `png` file. I followed the first part of the [Notepad](https://developer.android.com/resources/tutorials/notepad/notepad-ex2.html) tutorial to learn how to insert a menu. It's used to display an [AlertDialog](https://developer.android.com/guide/topics/ui/dialogs.html) with a key showing how to read the card.
